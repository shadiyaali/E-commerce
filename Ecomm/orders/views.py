...
def payments(request, total=0):
  ...
  currency = 'INR'
  razorpay_client = razorpay.Client(auth=(settings.RAZORPAY_KEY_ID, settings.RAZORPAY_KEY_SECRET_ID))
...
def payment_status(request):
    ...
    razorpay_client = razorpay.Client(
      auth=(settings.RAZORPAY_KEY_ID, settings.RAZORPAY_KEY_SECRET_ID))
